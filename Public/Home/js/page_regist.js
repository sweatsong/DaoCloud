	...
	/*var validate = $("#signupForm").validate({
		...
		messages: {
			...
			password: {
				...
				minlength: jQuery.format($.i18n.prop("请输入4到16个字符")),
				maxlength: jQuery.format($.i18n.prop("密码格式不正确"))
			},
			passwordAgain: {
				required: $.i18n.prop("重复输入密码"),
				minlength: jQuery.format($.i18n.prop("请输入4到16个字符")),
				maxlength: jQuery.format($.i18n.prop("密码格式不正确")),
